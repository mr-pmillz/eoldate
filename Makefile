...
compress:
	...
	gzip -9 bin/linux/arm64/eoldate-$(CURRENT_TAG)-linux-arm64
	gzip -9 bin/darwin/amd64/eoldate-$(CURRENT_TAG)-x86_64-macos-darwin_amd64
	gzip -9 bin/darwin/arm64/eoldate-$(CURRENT_TAG)-x86_64-macos-darwin_arm64
